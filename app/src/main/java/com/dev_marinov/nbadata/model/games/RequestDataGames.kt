...
object RequestDataGames {
    ...
    suspend fun getHashMap(client: OkHttpClient, request: Request): HashMap<Int, ObjectListGames> {
                ...
                override fun onResponse(call: Call, response: Response) {
                    ...
                    try {
                        ...
                        for (n in 0 until k) {// until значит что n in [1, 10), 10 будет исключён
                            ...
                            hashMap[n] = ObjectListGames(date, teamHome, cityHome, conferenceHome, divisionHome,
