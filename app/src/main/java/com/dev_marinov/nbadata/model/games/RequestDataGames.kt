...
//    suspend fun getHashMap(client: OkHttpClient, request: Request): HashMap<Int, Games> {
//
...
//
//                    val hashMap: HashMap<Int, Games> = HashMap()
//
//                    try {
...
//
//                            hashMap[n] = Games(date, teamHome, cityHome, conferenceHome, divisionHome,
